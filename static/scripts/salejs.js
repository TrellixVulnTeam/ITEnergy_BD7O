(function () {
    ...
    var t = function (key, options) {
        ...
        var str = app.translation[key] || ('no translation for ' + key);
    ...
    app.loadResources = function (callback) {
        ...
        requireJQuery(baseUrl + 'scripts/jquery.min.js', fork(callback, function (jQuery) {
            $ = jQuery;
            ...
            loadCss(baseUrl + '/static/styles/bootstrap-widget.css'
                , 'bootstrap-widget-loaded', fork(callback, function () {
                    loadCss(baseUrl + '/static/styles/cart.css', 'cart-loaded', done)
                }));

            loadJs(baseUrl + '/static/scripts/bootstrap.js', done);
            loadJs(baseUrl + '/static/scripts/' + language + '.js', done)
        }))
    };
